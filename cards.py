...
class Card:
    def __init__(self, input_value, input_suit):
        ...
        self.uuid = None # Unique identifer
        self.position = None
        self.start_position = (0, 1080) # Bottom Left Corner of the screen
        ...
        self.card_img = pygame.image.load(self.img) # Cargamos la imagen que pasamos anteriormente en self.img
        self.card_img = pygame.transform.scale(self.card_img, (self.card_img.get_width() * 4, self.card_img.get_height() * 4)) # Aumentamos 4 veces su tamaño
